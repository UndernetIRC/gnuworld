 ...
 * USA.
 *
 * $Id: REMOVEIGNORECommand.cc,v 1.8 2003/06/28 01:21:19 dan_karrels Exp $
 */
...
const char REMOVEIGNORECommand_cc_rcsId[] = "$Id: REMOVEIGNORECommand.cc,v 1.8 2003/06/28 01:21:19 dan_karrels Exp $";
