 ...
 * USA.
 *
 * $Id: ccBadChannel.cc,v 1.3 2003/06/28 01:21:19 dan_karrels Exp $
 */
...
const char ccBadChannel_cc_rcsId[] = "$Id: ccBadChannel.cc,v 1.3 2003/06/28 01:21:19 dan_karrels Exp $";
