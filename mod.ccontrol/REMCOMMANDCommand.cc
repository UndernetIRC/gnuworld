 ...
 * USA.
 *
 * $Id: REMCOMMANDCommand.cc,v 1.12 2003/06/28 01:21:19 dan_karrels Exp $
 */
...
const char REMCOMMANDCommand_cc_rcsId[] = "$Id: REMCOMMANDCommand.cc,v 1.12 2003/06/28 01:21:19 dan_karrels Exp $";
