 ...
 * USA.
 *
 * $Id: CHECKNETCommand.cc,v 1.12 2003/06/28 01:21:19 dan_karrels Exp $
 */
...
const char CHECKNETCommand_cc_rcsId[] = "$Id: CHECKNETCommand.cc,v 1.12 2003/06/28 01:21:19 dan_karrels Exp $";
