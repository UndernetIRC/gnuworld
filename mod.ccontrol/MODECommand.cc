 ...
 * USA.
 *
 * $Id: MODECommand.cc,v 1.17 2003/06/28 01:21:19 dan_karrels Exp $
 */
...
const char MODECommand_cc_rcsId[] = "$Id: MODECommand.cc,v 1.17 2003/06/28 01:21:19 dan_karrels Exp $";
