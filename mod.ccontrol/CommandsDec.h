    ...
    class commName##Command : public Command {                                                     \
      public:                                                                                      \
        commName##Command(ccontrol* _bot, const string& _commName, const string& _help,            \
                          const bool _needDB, int _flags, bool isDisabled, bool needOp,            \
                          bool noLog, int minLevel, bool secondAccess)                             \
            : Command(_bot, _commName, _needDB, _help, _flags, isDisabled, needOp, noLog,          \
                      minLevel, secondAccess) {}                                                   \
