...
const unsigned long int OPER = UHS | flg_MODE | flg_OP | flg_DEOP | flg_MODERATE | flg_UNMODERATE |
                               flg_INVITE | flg_GLINE | flg_SCGLINE | flg_REMGLINE | flg_LOPCHN |
                               flg_CHINFO | flg_WHOIS | flg_TRANS | flg_KICK | flg_CLEARCHAN |
                               flg_LISTHOSTS | flg_MODOP;
const unsigned long int SOPER = flg_CHECKNET | flg_LISTIGNORES | flg_LIST | flg_NOTES |
                                flg_USERINFO | flg_SCAN | flg_MAXUSERS | flg_LASTCOM | flg_REOP |
                                flg_UNJUPE | flg_ANNOUNCE | flg_TOPIC;
const unsigned long int ADMIN = OPER | flg_JUPE | flg_REMOPCHN | flg_ADDOPCHN | flg_ADDNOP |
                                flg_REMOP | flg_ADDCMD | flg_DELCMD | flg_SUSPEND | flg_UNSUSPEND;
const unsigned long int SADMIN = SOPER | flg_FGLINE | flg_REMIGNORE | flg_FORCECHANGLINE;
...
const unsigned long int SCODER = SSMT | flg_COMMANDS | flg_GCHAN | flg_RGCHAN | flg_STATUS |
                                 flg_SHUTDOWN | flg_CONFIG | flg_SAY | flg_SGLINE | flg_REMSGLINE |
                                 flg_SCHANGLINE | flg_LIMITS;
} // namespace commandLevel
