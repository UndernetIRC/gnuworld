 ...
 * USA.
 *
 * $Id: LISTOPERCHANSCommand.cc,v 1.7 2003/06/28 01:21:19 dan_karrels Exp $
 */
...
const char LISTOPERCHANSCommand_cc_rcsId[] = "$Id: LISTOPERCHANSCommand.cc,v 1.7 2003/06/28 01:21:19 dan_karrels Exp $";
