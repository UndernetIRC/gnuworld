...
bool sqlcfUser::commit(dbHandle* cacheCon) {
    ...
    if (!cacheCon->Exec(userCommit.str())) {
        elog << "sqlcfUser::commit> Something went wrong: " << cacheCon->ErrorMessage()
             << std::endl;
        retval = false;
    } else
        retval = true;
...
bool sqlcfUser::Insert(dbHandle* cacheCon) {
    ...
    if (!cacheCon->Exec(insertString.str())) {
        elog << "sqlcfUser::Insert> Something went wrong: " << cacheCon->ErrorMessage()
             << std::endl;
        retval = false;
        maxUserId--;
    } else
...
bool sqlcfUser::Delete(dbHandle* cacheCon) {
    ...
    if (!cacheCon->Exec(hostString.str())) {
        elog << "sqlcfUser::Delete> Something went wrong: " << cacheCon->ErrorMessage()
             << std::endl;
        retval = false;
    } else
        retval = true;
...
bool sqlcfUser::addHost(dbHandle* cacheCon, const std::string& _theHost) {
    ...
    if (!cacheCon->Exec(insertString.str())) {
        elog << "sqlcfUser::addHost> Something went wrong: " << cacheCon->ErrorMessage()
             << std::endl;
        retval = false;
    } else
        retval = true;
...
bool sqlcfUser::delHost(dbHandle* cacheCon, const std::string& _theHost) {
    ...
    if (!cacheCon->Exec(deleteString.str())) {
        elog << "sqlcfUser::delHost> Something went wrong: " << cacheCon->ErrorMessage()
             << std::endl;
        retval = false;
    } else
        retval = true;
