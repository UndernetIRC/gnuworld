 ...
 * Combine with bitwise OR; ALL (127) matches every source.
 *
...
const int CTCP      = 64;  // CTCP (direct or channel), to the bot or a spy client
const int ALL       = 127; // all of the above
