 ...
 * USA.
 *
 * $Id: ConnectionHandler.h,v 1.2 2002/05/27 17:53:04 dan_karrels Exp $
 */

#ifndef __CONNECTIONHANDLER_H
#define __CONNECTIONHANDLER_H "$Id: ConnectionHandler.h,v 1.2 2002/05/27 17:53:04 dan_karrels Exp $"
