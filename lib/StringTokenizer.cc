 ...
 * USA.
 *
 * $Id: StringTokenizer.cc,v 1.5 2002/05/27 17:18:12 dan_karrels Exp $
 */
...
const char StringTokenizer_cc_rcsId[] = "$Id: StringTokenizer.cc,v 1.5 2002/05/27 17:18:12 dan_karrels Exp $" ;
