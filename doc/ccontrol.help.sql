...
LIMITS		3	LIMITS commands: addisp, addnetblock, delisp, delnetblock, list, chlimit, chilimit, chname, chemail, forcecount, glunidented, active, nogline, group, chccidr, clearall, userinfo, info, ipinfo
