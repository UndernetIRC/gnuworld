...
1	4	Sorry, the basket %s is empty	31337
1	5	I don't see %s anywhere	31337
1	6	I can't find %s on basket %s	31337
1	7	The basket %s doesn't appear to be registered	31337
1	8	You're opped by %s (%s)	31337
1	9	You're voiced by %s (%s)	31337
1	10	%s: You are not in that basket	31337
...
1	27	basket: %s -- AUTOMODE: %s	31337
...
1	57	The basket %s has been suspended by a cservice administrator.	31337
...
1	78	Modified %s's access level on basket %s to %i	31337
1	79	Set AUTOMODE to OP for %s on basket %s	31337
1	80	Set AUTOMODE to VOICE for %s on basket %s	31337
1	81	Set AUTOMODE to NONE for %s on basket %s	31337	
...
1	87	Purged basket %s	31337
1	88	%s is already registered with me.	31337
1	89	Invalid basket name.	31337
1	90	Registered basket %s	31337
...
1	94	You can't remove yourself from a basket you own	31337
...
1	116	Can't locate basket %s on the network!	31337
1	117	ERROR: Invalid basket setting.	31337
1	118	Ignore list:	31337
1	119	Ignore list is empty	31337
1	120	-- End of Ignore List	31337
1	121	CMaster basket Services internal status:	31337
1	122	[     basket Record Stats] \002Cached Entries:\002 %i    \002DB Requests:\002 %i    \002Cache Hits:\002 %i    \002Efficiency:\002 %.2f%%	31337
...
1	127	Last recieved basket NOTIFY: %i	31337
...
1	132	basket %s has %d users (%i operators)	31337
...
1	156	%s: Cleared basket modes.	31337
...
1	164	 and an Easter Bunny	31337
1	165	Added ban %s to %s at level %i	31337
1	166	%s: ban list is empty.		31337
1	167	I'm already in that basket!	31337
1	168	This command is reserved to Easter Bunnies	31337
