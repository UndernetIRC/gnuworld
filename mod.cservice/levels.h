#ifndef __LEVELS_H
#define __LEVELS_H "$Id: levels.h,v 1.14 2001/02/28 22:50:36 plexus Exp $"
 ...
 *
 * $Id: levels.h,v 1.14 2001/02/28 22:50:36 plexus Exp $
 */
...
namespace gnuworld {
 ...
 namespace level {
  ...
  namespace coder {
        const int base = 200;
	const int contrib = 400;
	const int devel = 499;
	const int senior = 1000;
  }
