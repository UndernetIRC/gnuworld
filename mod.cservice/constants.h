...
#define __CONSTANTS_H "$Id: constants.h,v 1.19 2002/02/24 01:04:06 gte Exp $"
 ...
 *
 * $Id: constants.h,v 1.19 2002/02/24 01:04:06 gte Exp $
 */
...
namespace sql
	...
	const string user_fields = "id,user_name,password,url,language_id,flags,last_updated_by,last_updated,email,maxlogins";
