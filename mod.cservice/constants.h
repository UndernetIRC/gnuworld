...
#define __CONSTANTS_H "$Id: constants.h,v 1.12 2001/03/11 02:00:23 gte Exp $"
 ...
 *
 * $Id: constants.h,v 1.12 2001/03/11 02:00:23 gte Exp $
 */
...
namespace sql
	...
	const string user_fields = "id,user_name,password,url,language_id,flags,last_updated_by,users.last_updated,users_lastseen.last_seen";
