...
const std::string channel_fields =
    ...
    "limit_max,max_bans,no_take,welcome,limit_joinmax,limit_joinsecs,limit_joinperiod,limit_"
    "joinmode";
...
const std::string ban_fields =
    "id,channel_id,banmask,set_by,set_ts,level,expires,reason,last_updated";
} // namespace sql
} // namespace gnuworld
