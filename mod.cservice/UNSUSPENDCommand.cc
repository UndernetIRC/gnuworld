 ...
 * Caveats: None.
 *
 * $Id: UNSUSPENDCommand.cc,v 1.16 2001/08/30 19:30:20 gte Exp $
 */
...
const char UNSUSPENDCommand_cc_rcsId[] = "$Id: UNSUSPENDCommand.cc,v 1.16 2001/08/30 19:30:20 gte Exp $" ;
