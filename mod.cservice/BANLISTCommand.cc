 ...
 * Caveats: None.
 *
 * $Id: BANLISTCommand.cc,v 1.10 2001/03/17 02:54:56 isomer Exp $
 */
...
const char BANLISTCommand_cc_rcsId[] = "$Id: BANLISTCommand.cc,v 1.10 2001/03/17 02:54:56 isomer Exp $" ;
...
if( !inChan && !(bot->getAdminAccessLevel(theUser)>0))
	{
