 ...
 * 
 * $Id: sqlChannel.cc,v 1.25 2001/03/13 22:39:33 gte Exp $
 */
...
const char sqlChannel_cc_rcsId[] = "$Id: sqlChannel.cc,v 1.25 2001/03/13 22:39:33 gte Exp $" ;
...
queryString	<< "SELECT "
		<< sql::channel_fields
		<< " FROM channels WHERE registered_ts <> 0 AND deleted = 0 AND id = "
		<< channelID
		<< ends ;
