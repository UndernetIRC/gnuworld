 ...
 * 
 * $Id: sqlChannel.cc,v 1.21 2001/02/04 23:37:32 gte Exp $
 */
...
const char sqlChannel_cc_rcsId[] = "$Id: sqlChannel.cc,v 1.21 2001/02/04 23:37:32 gte Exp $" ;
...
bool sqlChannel::loadData(const string& channelName)
{
    ...
    string queryString = "SELECT " + sql::channel_fields + " FROM channels WHERE registered_ts <> 0 AND deleted = 0 AND lower(name) = '" + escapeSQLChars(string_lower(channelName)) + "'";
