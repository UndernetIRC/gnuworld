 ...
 *
 * $Id: CLEARMODECommand.cc,v 1.5 2001/03/06 02:34:32 dan_karrels Exp $
 */
...
const char CLEARMODECommand_cc_rcsId[] = "$Id: CLEARMODECommand.cc,v 1.5 2001/03/06 02:34:32 dan_karrels Exp $" ;
